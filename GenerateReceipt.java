/*
 * This will print a receipt that includes appointment information and billing information for the specified client.
 * 
 * @author: Sydni Smith
 */
...
public class GenerateReceipt  extends JFrame{
  ...
  public int getBalance(){
    return MakeAppointment.Balance();
  }
  ...
  public String ValidateClientUsername(){
    return ClientAccount.ClientUsername();
  }
